...
/***/ function(module, exports, __webpack_require__) {
	...
	var Component = (function (_React$Component) {
	  ...
	  Component.prototype.hasError = function hasError() {
	    ...
	    if (_tcombValidation2['default'].Function.is(optionsHasError)) {
	      var _getValidationOptions2 = this.getValidationOptions();
	
	      var path = _getValidationOptions2.path;
	      var context = _getValidationOptions2.context;
